...
#. An AWS account. Some of the images we suggest have `free tiers available <https://aws.amazon.com/free>`_.
...
#. Log in to `AWS Console <https://console.aws.amazon.com/>`_ with
   your account.
